...
public class RedTankSpawner1 : MonoBehaviour
{
    ...
    Vector3 tankSpawnLocation2Lv1 = new Vector3(4, .8f, 0);            //this spawns location for the sinper and mortar tank
    ...
    Vector3 tankSpawnLocation2Lv2 = new Vector3(11, .8f, 0);            //this spawns location for the sinper and mortar tank
    ...
    void Start()
    {
        ...
        if(whatLevelAmI == 1)
        {
            ...
            else { Instantiate(redTanksPreFabs[(getPicks[0] - 1)], tankSpawnLocation2Lv1, Quaternion.Euler(0, 0, 0)); }
        }
        else if(whatLevelAmI == 2)
        {
            if ((getPicks[0] - 1) == 0)
            { Instantiate(redTanksPreFabs[(getPicks[0] - 1)], tankSpawnLocationLv2, Quaternion.Euler(0, 0, 0)); }
            else { Instantiate(redTanksPreFabs[(getPicks[0] - 1)], tankSpawnLocationLv2, Quaternion.Euler(0, 0, 0)); }

            if ((getPicks[1] - 1) == 0)
            { Instantiate(redTanksPreFabs[(getPicks[1] - 1)], tankSpawnLocation2Lv2, Quaternion.Euler(0, 0, 0)); }
            else { Instantiate(redTanksPreFabs[(getPicks[1] - 1)], tankSpawnLocation2Lv2, Quaternion.Euler(0, 0, 0)); }
        }
